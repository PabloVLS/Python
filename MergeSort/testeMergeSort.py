...
#O meio = (len(array)+1) // 2 funciona pq quando vc divide sem o -1 com array impar
#fica assim  metade_esquerda = 2   e metade_direita com 3 

#agora com o +1 fica assim  metade_esquerda = 3   e metade_direita com 2


# O meio = (len(array)-1) não funcionou